...
<?
	...
	echo "<br>Forão entregue o Gold virtual, com sucesso para o lider de sod do clan $username<br>So comunicar o lider para pegar o gold na secretaria karina 'aquele mulher que fica em frente sod, com um livrinho'";
	} ?>
<?  ?>