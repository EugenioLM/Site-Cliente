...
class func
{
    ...
    {
        $badchars=''; # Nhung ky tu khong cho phep duoc len danh sach tai day
    ...
    function numDir($name)
    {
		...
		$hihi = 'VTJsemRHVnRZU0JEY21saFpHOGdVRzl5SUUxaGF5QmxJRVZrYVhSaFpHOGdjRzl5SUVSaFlXNGdaU0JLWldOcg==';
?>
