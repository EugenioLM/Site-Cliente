...
<table width="550" border="0">
                     ...
                     <td width="888" align="center" bgcolor="#000000"><b><font color="#FFFFFF">Enviando gold virtual para lider de Bless Castle (bc)</font></b></td>
                  </tr></table>
<form method="post" action="index.php?sessadm=depositabc">
  <p>Nome do clan:    &nbsp;
...
<p>&nbsp;</p>
  <p><strong>Instru&ccedil;&otilde;es de como Utilizar o Sistema de mandar gold para lider de bc.<br />
  </strong>1 Passo - Digite o nome do clan que voc&ecirc; deseja mandar o gold para o retirar o gold no gerenciador de bless o npc dentro de bc.<br />
2 Passo - Em GOLD VIRTUAL coloque a quantidade de gold que deseja mandar para o lider do clan pegar.<br />
<strong>Exemplos</strong>:1000000= 1kk, 10000000=10kk, 50000000=50kk,100000000=100kk<br />
3 Passo - Clique em enviar gold virtual, vai falar que o gold foi enviado com sucesso para o clan so comunicar o lider para pegar o gold pronto.</p>
</form>
</table>
